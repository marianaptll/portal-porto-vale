  ...
  return (
    ...
    >
      ...
      <div className="px-3 pb-3 sm:hidden">
        <button
          onClick={onComprar}
          className="w-full h-9 bg-primary text-white text-xs font-bold rounded-xl flex items-center justify-center gap-2 shadow-sm active:scale-95 transition-transform"
        >
      ...
      >
        <div className="p-4 space-y-3">
          <motion.div variants={itemVariants}>
            ...
            {isLoja ? (
              <p className="text-base font-extrabold text-amber-300 mt-0.5">{formatBRL(preco)}</p>
            ) : (
