export default function SegurosSection() {
  return (
    <section className="mb-16 bg-secondary-container/10 dark:bg-slate-900/50 p-10 rounded-3xl border border-secondary/5 dark:border-slate-700/30">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {/* Sale Launch Card */}
        <div className="bg-white dark:bg-slate-800 p-2 rounded-2xl flex items-center shadow-sm overflow-hidden group border border-outline-variant/5 dark:border-slate-700/30">
          <div className="h-48 w-44 overflow-hidden rounded-xl shrink-0">
            <img
